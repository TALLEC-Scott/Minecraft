...
#  define ZoneText(txt, len)         do {} while (0)
#  define ZoneValue(val)             do {} while (0)
#  define FrameMark                  do {} while (0)
#  define FrameMarkNamed(name)       do {} while (0)
#  define TracyPlot(name, val)       do {} while (0)
#  define TracyMessageL(msg)         do {} while (0)
#endif
